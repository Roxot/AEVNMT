...
class CBaselineModel(AttentionModel):
  ...
  def _parse_iterator(self, iterator, hparams, scope=None):
    self.source = tf.nn.embedding_lookup(self.embedding_encoder, iterator.source)
    self.source_output = tf.nn.embedding_lookup(self.embedding_encoder,
